...
export const DeleteButton = (props: SendButtonProps) => {
  // Check if <plainbots-fullchatbot> is present in the DOM
  const isFullChatbot = document.querySelector('plainbots-fullchatbot') !== null;
...
export const Spinner = (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
  <svg
    {...props}
    class={'animate-spin -ml-1 mr-3 h-5 w-5 spinner-bg-custom' + props.class}
